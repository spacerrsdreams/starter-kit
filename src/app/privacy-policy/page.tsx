...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-3xl space-y-8 px-6 py-20 text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-5">
            <li>
              <span className="font-medium text-foreground">Service and product messages.</span> Receive product
